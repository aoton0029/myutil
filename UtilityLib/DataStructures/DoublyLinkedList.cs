...
using UtilityLib.Extentions;

namespace UtilityLib.DataStructures
{
    public class DoublyLinkedListNode<T> : IComparable<DoublyLinkedListNode<T>> where T : IComparable<T>
    {
        ...
        public DoublyLinkedListNode() : this(default(T)) { }
        public DoublyLinkedListNode(T dataItem) : this(dataItem, null, null) { }
        public DoublyLinkedListNode(T dataItem, DoublyLinkedListNode<T> next, DoublyLinkedListNode<T> previous)
        {
            Data = dataItem;
            Next = next;
            Previous = previous;
    ...
    public class DoublyLinkedList<T> : IEnumerable<T> where T : IComparable<T>
    {
        ...
        /// </summary>
        private int _count;
        private DoublyLinkedListNode<T> _firstNode { get; set; }
        private DoublyLinkedListNode<T> _lastNode { get; set; }

        public virtual DoublyLinkedListNode<T> Head
        {
        ...
        protected virtual T _getElementAt(int index)
        {
            ...
            DoublyLinkedListNode<T> currentNode = null;
        ...
        public virtual void Remove(T dataItem)
        {
            ...
            else
            {
                ...
                // Remove element
                DoublyLinkedListNode<T> newPrevious = currentNode.Previous;
                DoublyLinkedListNode<T> newNext = currentNode.Next;
