...
namespace UtilityLib.DataStructures
{
    public class SingleLinkedListNode<T> : IComparable<SingleLinkedListNode<T>> where T : IComparable<T>
    {
        ...
        public SingleLinkedListNode(T dataItem)
        {
            Next = null;
            Data = dataItem;
        }
    ...
    public class SingleLinkedList<T> : IEnumerable<T> where T : IComparable<T>
    {
        ...
        /// </summary>
        private int _count;
        private SingleLinkedListNode<T> _firstNode { get; set; }
        private SingleLinkedListNode<T> _lastNode { get; set; }
        ...
        public virtual SingleLinkedListNode<T> Head
        {
        ...
        {
            SingleLinkedListNode<T> newNode = new SingleLinkedListNode<T>(dataItem);
        ...
        public void InsertAt(T dataItem, int index)
        {
            ...
            {
                var currentNode = _firstNode;
                var newNode = new SingleLinkedListNode<T>(dataItem);
        ...
        public SingleLinkedList<T> GetRange(int index, int countOfElements)
        {
        ...
        internal class SLinkedListEnumerator : IEnumerator<T>
        {
            ...
            private SingleLinkedList<T> _doublyLinkedList;

            public SLinkedListEnumerator(SingleLinkedList<T> list)
            {
